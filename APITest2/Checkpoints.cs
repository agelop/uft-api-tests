...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_ConcatenateStringsActivity4_checkpoints(STActivityBase activity)
        {
            // Checkpoint 1
            ...
            BindDirection actualBindDirection1 = new BindDirection(_flow.ConcatenateStringsActivity4, actualValueGetter1, actualValueSetter1);
            CpValObj valueActualObject1 = new CpValObj(actualBindDirection1, XmlTypeCode.String, false);
            CpValObj valueExpectedObject1 = new CpValObj("ByeHey", XmlTypeCode.String);
